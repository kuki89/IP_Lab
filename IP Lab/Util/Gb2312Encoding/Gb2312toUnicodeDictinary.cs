...
namespace LIMS.Analysis.Helpers
{
    ...
    /// tochar
    /// </summary>
    static class Gb2312toUnicodeDictinary
    {
        ...
        public static bool TryGetChar(byte[] b, out char gbchar)
        {
            ...
            UInt16 value;
            if (gb2312toUnicode.TryGetValue(key, out value))
            {
        ...
        public static Dictionary<UInt16, UInt16> gb2312toUnicode = new Dictionary<UInt16, UInt16>()
        {
            {0x2121,0x3000},
              {0x2122,0x3001},
            {0x2123,0x3002},
