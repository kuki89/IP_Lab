...
{
    public class Device_Linux : DeviceBase
    {
        protected override void Init_Property(int index = 1)
        {
            ...
            int maxCount = Util.SingletonGeneric<Data.SystemData>.GetInstance.
                DeviceMaxCount[(int)Enum.DeviceType.DEVICE_TYPE_LINUX];
            ...
            DP.Product = "Linux";
            DP.Type = Enum.DeviceType.DEVICE_TYPE_LINUX;
            DP.Prefix = "VMLinux";
        ...
        protected override void Init_Control()
        {
            ...
            IcoImage = new BitmapImage(new Uri(
                string.Format(@"/{0};component/Resource/Image/linux.png",
